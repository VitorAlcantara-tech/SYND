...
export default function Init() {
    return (
        <main className="w-full min-h-screen overflow-x-hidden text-white" style={{
            background: "radial-gradient(114.7% 102.32% at 17.65% 50.35%, #0f71a6 5%, #06486C 45%, #002740 100%"
        }}>
            ...
            <nav className="w-full flex flex-row flex-wrap justify-between gap-4 px-6 md:px-15 pt-6 md:pt-10">
                ...
                <Link href={"/vendedor-dash"} className="h-full py-1 px-3 rounded-sm bg-[#00A2FF] font-md font-light shadow-[0px_5px_1px_-3px_rgba(0,0,0,0.3)] hover:shadow-[0px_1px_5px_-3px_rgba(0,0,0,0.3)] btn-light-hover">
                    Entrar
                </Link>
            </nav>
